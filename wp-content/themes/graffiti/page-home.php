            ...
            <div class="thesis-pic">
              <a href="#svg1" title="My logo generated by the Graffiti wordpress theme">
                <svg width="240" height="240" viewBox="0 0 240 240" preserveAspectRatio="xMinYMax meet">
                  <!-- Static Cube (3 Shape Posts) -->
                  <!--
                  <polygon points='25,66,25,178,114,220,113,110' title='shape left' alt='shape left' />
                  <polygon points='126,109,126,222,218,177,218,65' title='shape right' alt='shape right' />
                  <polygon points='26,56,120,101,213,56,120,13' title='shape top' alt='shape top' />
                  -->
